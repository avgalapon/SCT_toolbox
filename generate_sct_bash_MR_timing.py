...
json_path = fr"/home/galaponav/art/scripts/PhD/SCT_toolbox/tp_testMR_timing.json"
...
print(patient_list)
list_suffix = ['_single_DIR', '_dropout_DIR'] # '_single_Eval', '_dropout_Eval', '_single_DIR', '_dropout_DIR' '_single_noEval', '_dropout_noEval'
...
for patient in patient_list:
    ...
    for model in model_list:
        for sufff in list_suffix:            
            ...
            cmd = f"python /home/galaponav/art/scripts/PhD/SCT_toolbox/CTsynthesizer1.py {json_path}"
            os.system(cmd)
            ...
            # Iterate through the delete list and remove files not in the exception list
